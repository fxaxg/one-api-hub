...
本插件可以便捷的对基于 [one-api](https://github.com/songquanpeng/one-api) 、 [new-api](https://github.com/QuantumNous/new-api)
和 [Veloera](https://github.com/Veloera/Veloera) 等部署的 AI 中转站账号进行整合管理。
